<%@ Page Title="Gestisci account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="AlphaASPWebsite.Account.Manage" %>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:CompareValidator runat="server" ControlToCompare="Password" ControlToValidate="confirmPassword"
                                    CssClass="text-error" Display="Dynamic" ErrorMessage="La password e la password di conferma non corrispondono."
                                    ValidationGroup="SetPassword" />
