<%@ Page Title="Accedi" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AlphaASPWebsite.Account.Login" Async="true" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4>Iscriviti per condividere le tue citazioni preferite, è semplice e gratis!</h4>
                    <hr />
